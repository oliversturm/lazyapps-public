...
{#if question}
	<div class="flex flex-row w-screen">
		<div class="ml-2 flex flex-col gap-4 border-r-2 border-blue-800 pr-2">
		...
		<div class="flex flex-col mr-2 mt-4 pl-2 border-l-2 border-blue-600">
...
{#if roundAnswerDisplay}
	{#if lastMainRoundAnswerCorrect}
		...
		{#if mainRoundNumber === 4}
			<button class="control" on:click={endRound}>End Round</button>
		{:else}
			<button class="control" on:click={proceed}>Proceed</button>
		{/if}
	{:else}
